...
from awsome.api.v1.model_setting_cfg import router as model_setting_cfg_router
from awsome.api.v1.model_available_cfg import router as model_available_cfg_router
